...
const T = {
  ...
  hu: {
    ...
    grade_outstanding:        'Kiválóan teljesített.',
    grade_excellent:          'Jól teljesített.',
    grade_proficient:         'Helytálló.',
    grade_developing:         'Megfelelt.',
    grade_beginning:          'Részt vett.',
    msg_outstanding:          'Kiválóan teljesített. A vizsgán számon kérteket érti, önállóan tudja alkalmazni és azokkal teljeskörűen tisztában van.',
    msg_excellent:            'Jól teljesített. Ismereteit jól átlátja, érti, és tudja azokat önállóan alkalmazni.',
    msg_proficient:           'Helytálló. Ismereteit megfelelő szinten érti, tudja alkalmazni önállóan.',
    msg_developing:           'Megfelelt. Ismereteit a legalsó értékelhető szinten érti.',
    msg_beginning:            'Részt vett. Nem értékelhető a teljesítménye.',
