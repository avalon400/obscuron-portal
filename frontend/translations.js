...
const T = {
  ...
  hu: {
    ...
    grade_7c:                 'Hetedik szint C kat.',
    grade_7b:                 'Hetedik szint B kat.',
    grade_7a:                 'Hetedik szint A kat.',
    grade_6:                  'Hatodik szint',
    grade_5:                  'Ötödik szint',
    grade_4:                  'Negyedik szint',
    grade_3:                  'Harmadik szint',
    grade_2:                  'Második szint',
    grade_1:                  'Első szint',
    grade_0:                  'Értékelhetetlen',
    msg_7c:                   'Hetedik szint C kategóriáját érte el, kiemelkedő teljesítmény — ez a hetedik szint legfelső csoportja.',
    msg_7b:                   'Hetedik szint B kategóriáját érte el, kiemelkedő teljesítmény — ez a hetedik szint közepe.',
    msg_7a:                   'Hetedik szint A kategóriáját érte el, kiemelkedő teljesítmény — ez a hetedik szint alapcsoportja.',
    ...
    // Admin login
    admin_login_title:        'Vizsgáztatói hozzáférés',
